      ...
      items: [
        {
          icon: Building2,
          label: 'Workspace',
          href: `/workspace/${workspaceUrl}/settings/workspace`,
          description: 'Manage workspace settings and branding'
        },
        {
          icon: FolderOpen,
          label: 'Projects',
          href: `/workspace/${workspaceUrl}/settings/projects`,
          description: 'Create and manage projects'
        },
        {
          icon: Users,
          label: 'Teams',
          href: `/workspace/${workspaceUrl}/settings/teams`,
          description: 'Create and manage teams'
        },
        {
          icon: UserPlus,
          label: 'Members',
          href: `/workspace/${workspaceUrl}/settings/members`,
      ...
      items: [
        {
          icon: FileType,
          label: 'Issue Types',
          href: `/workspace/${workspaceUrl}/settings/issue-types`,
          description: 'Define different types of issues (Bug, Feature, Task, etc.)'
        },
        {
          icon: GitBranch,
          label: 'Issue Statuses',
          href: `/workspace/${workspaceUrl}/settings/statuses`,
          description: 'Configure issue statuses and transitions'
        },
        {
          icon: Tag,
          label: 'Labels',
          href: `/workspace/${workspaceUrl}/settings/labels`,
          description: 'Manage issue labels and categories'
        },
        {
          icon: Settings,
          label: 'Custom Fields',
          href: `/workspace/${workspaceUrl}/settings/custom-fields`,
      ...
      items: [
        {
          icon: User,
          label: 'Profile',
          href: `/workspace/${workspaceUrl}/settings/profile`,
          description: 'Manage your profile and account'
        },
        {
          icon: Bell,
          label: 'Notifications',
          href: `/workspace/${workspaceUrl}/settings/notifications`,
          description: 'Configure notification preferences'
        },
        {
          icon: Shield,
          label: 'Security & access',
          href: `/workspace/${workspaceUrl}/settings/security`,
      ...
      <div className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 overflow-y-auto">
        ...
        <div className="p-4 border-b border-slate-200 dark:border-slate-700">
          <div className="flex items-center gap-2 mb-2">
            <Link href={`/workspace/${workspaceUrl}`}>
