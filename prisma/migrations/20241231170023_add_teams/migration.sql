...
CREATE TABLE "UserPreferences" (
    ...
    "userId" TEXT NOT NULL,
    "workspaceId" TEXT NOT NULL,
    "defaultHomeView" TEXT NOT NULL DEFAULT 'list',
    "fontSize" TEXT NOT NULL DEFAULT 'normal',
    "usePointerCursor" BOOLEAN NOT NULL DEFAULT false,
    "displayFullNames" BOOLEAN NOT NULL DEFAULT true,
...
-- AddForeignKey
ALTER TABLE "UserPreferences" ADD CONSTRAINT "UserPreferences_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
